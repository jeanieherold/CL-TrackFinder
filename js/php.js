...
$('#php-total-badges').html('<h2 class="gray">PHP Badges Needed to Graduate: ' + totalBadges + ' </h2>');
...
$('#submit').on('click', function(event){
	...
	$('#php-user').html('<h2 class="purple">Student: ' + user + ' </h2>');
  ...
  $.getJSON(studentUrl, function(results){
    ...
    $('#php-badges-needed').html(phpNeedList);
     ...
     $('#php-user').html('<h2 class="purple">Student not found!</h2>');
